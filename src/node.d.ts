...
declare module "express"{
    ...
    module _express{
        ...
        class Request{
            ...
            csrfToken():string;
            ////my-validator
            validateBody(field:string):Validation;
            validateParams(field:string):Validation;
        ...
        interface Validation{
            ...
            length(max:number,arg2?:number):Validation;
            lines(max:number):Validation;
            isASCIIPrintable():Validation;
            isHiragana():Validation;
            isKatakana():Validation;
            isNumber(allowNegatives?:boolean):Validation;
            isInteger(allowNegatives?:boolean):Validation;
            isEmail():Validation;
            optional():Validation;
            ...
            isSeriesName():Validation;
            isSeriesDescription():Validation;
        }
...
declare module "node-jsx"{
    export function install(option?:{
        extension?:string;
        additionalTransform?:(string)=>string;
        harmony?:boolean;
    }):void;
}
