...
export default class GameController {
  ...
  getGame(
    ...
    playcount: boolean,
    callback: Callback<{
      game: GameData & { _id: any };
      metadata: GameMetadata & { _id: any };
    }>,
  ): void {
    var _this = this,
      game: GameData & { _id: any },
  ...
  //ゲームデータにユーザーデータを追加
  addUserData(
    games: Array<GameOpenMetadata>,
    callback: Callback<Array<GameOpenMetadataWithOwnerData>>,
  ): void {
