...
export default class SafeGameView extends React.PureComponent<IPropSafeGameView, IStateSafeGameView>{
    ...
    render(){
        ...
        if(confirm){
            ...
            content = <div className="game-safe-view-confirm" onClick={handleClick}>
                <p>
