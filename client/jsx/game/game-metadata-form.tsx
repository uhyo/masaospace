...
export default class GameMetadataForm extends React.Component<IPropGameMetadataForm, IStateGameMetadataForm>{
        ...
        return <form className="form" onSubmit={handleSubmit}>
            ...
            <div>
                <span className="form-row">
                    <span>タグ</span>
                    <StrList value={this.state.tags} onChange={this.handleTags.bind(this)} />
                </span>
            </div>
            <p>
                <label className="form-row">
