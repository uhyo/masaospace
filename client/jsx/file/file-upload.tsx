...
import { File as FileData } from '../data';
  ...
  render() {
    ...
    if (file != null && status != null) {
      ...
      filedataArea = (
        <FileDataForm
          ...
          submitButton={uploadtext}
          submitDisabled={disabled}
          previewURL={this.state.url}
          defaultFile={defaultData}
    ...
    return (
      <section className="file-upload">
        ...
        <FileSelector
          onSelect={this.handleFile.bind(this)}
          maxsize={this.props.config.filedata.maxSize}
        />
        {filedataArea}
      </section>
    );
