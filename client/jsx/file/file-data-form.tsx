...
export default class FileDataForm extends React.Component<
  IPropFileDataForm,
  IStateFileDataForm
> {
  /**
  ...
  render() {
    ...
    //ファイルの情報をアレする
    const usages = Object.keys(resourceKinds).map((key: ResourceKind) => [
      key,
      resourceKinds[key],
    ]);
          ...
          <p>
            <label className="form-row">
              ...
              <input
                ...
                readOnly
                defaultValue={defaultFile ? defaultFile.type : ''}
              />
            </label>
          </p>
          <p>
            <label className="form-row">
              <span>用途</span>
              <select
                ref={input => (this.usageInput = input)}
                defaultValue={defaultFile ? defaultFile.usage : ''}
              >
          ...
          <p>
            <label className="form-row">
              ...
              <textarea
                ...
                defaultValue={defaultFile ? defaultFile.description : ''}
              />
            </label>
          </p>
          <p>
